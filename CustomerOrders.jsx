...
const CustomerOrders = ({ orders, loading, onCreateOrder }) => {
  ...
  const totalReceived = orders.reduce((sum, order) => sum + order.amount_received, 0);
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-gray-50 p-4 rounded-md">
          ...
          <div className="text-2xl font-semibold text-red-600">₹{totalPending.toLocaleString('en-IN')}</div>
        </div>
      </div>
            ...
            <TableBody>
              {orders.map((order) => (
                <TableRow key={order.id}>
                  ...
                  <TableCell>{order.amount_received.toLocaleString('en-IN')}</TableCell>
